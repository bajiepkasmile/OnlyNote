package com.nodomain.onlynote.presentation.ui.recyclerviews.adapters
...
import com.nodomain.onlynote.presentation.ui.recyclerviews.viewholders.NoteViewHolder
...
class NotesAdapter(private var notes: MutableList<Note>) : RecyclerView.Adapter<NoteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NoteViewHolder?, position: Int) {
        ...
        holder?.tvCreatedTime?.text = note.createdDate.toString()
